...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.dialogInfoAction = new global::Gtk.Action ("dialogInfoAction", global::Mono.Unix.Catalog.GetString ("Provider"), null, "gtk-dialog-info");
		this.dialogInfoAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("Provider");
		...
		this.UIManager.AddUiFromString ("<ui><menubar name='menubar2'><menu name='InfoAction' action='InfoAction'><menuitem name='dialogInfoAction' action='dialogInfoAction'/></menu></menubar></ui>");
		...
		w2.Fill = false;
		// Container child vbox1.Gtk.Box+BoxChild
		this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem name='cdromAction' action='cdromAction'/></toolbar></ui>");
		...
		this.cdromAction.Activated += new global::System.EventHandler (this.GetProvidersInfo);
	}
}
